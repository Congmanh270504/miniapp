  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isCompleted && (
          <div className={`px-8 pb-8 relative z-[102] ${footerClassName}`}>
            <div
              className={`mt-10 flex relative z-[103] ${
            ...
            >
              ...
              <button
                ...
                className="duration-350 flex items-center cursor-pointer justify-center rounded-full bg-green-500 py-1.5 px-3.5 font-medium tracking-tight text-white transition hover:bg-green-600 active:bg-green-700 relative z-[104]"
                disabled={false}
    ...
    >
      ...
      >
        {status === "complete" ? (
          ...
          <div className="h-3 w-3 rounded-full bg-[#ffff]" />
        ) : (
